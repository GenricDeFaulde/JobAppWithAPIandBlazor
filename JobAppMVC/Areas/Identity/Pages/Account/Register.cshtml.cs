...
namespace JobApp.Areas.Identity.Pages.Account
{
  ...
  public class RegisterModel : PageModel
  {
    ...
    // TODO cleanup, enable alternative login providers, enable email sender
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
      ...
      {
        var user = new JobAppUser { UserName = Input.UName, Email = Input.Email, IsAdmin = Input.IsAdmin };
